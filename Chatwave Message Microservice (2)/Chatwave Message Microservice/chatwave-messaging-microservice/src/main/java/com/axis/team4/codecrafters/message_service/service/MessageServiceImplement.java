...
public class MessageServiceImplement implements MessageService {
	 ...
	 private final MessageRepository messageRepo;
	    private final MessageRepositoryRedis messageRepositoryRedis;
	    private final UserService userService;
	    private final ChatService chatService;

	    
	    public MessageServiceImplement(MessageRepository messageRepo,
	                            MessageRepositoryRedis messageRepositoryRedis,
	                            UserService userService,
	                            ChatService chatService) {
	        this.messageRepo = messageRepo;
	        this.messageRepositoryRedis = messageRepositoryRedis;
