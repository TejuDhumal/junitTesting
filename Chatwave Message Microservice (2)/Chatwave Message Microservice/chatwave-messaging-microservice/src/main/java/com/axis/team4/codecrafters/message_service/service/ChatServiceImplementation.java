...
public class ChatServiceImplementation implements ChatService {
    ...
    public ChatServiceImplementation(UserService userService,
    ...
    public Chat deleteChat(Integer chatId, Integer userId) throws ChatException, UserException {
        ...
        if (chat.getCreatedBy().getId().equals(user.getId()) && !chat.getIsGroup().booleanValue()) {
    ...
    public Chat blockChat(Integer chatId, Integer userId) throws UserException, ChatException {
        ...
        chat.setBlockedBy(user.getId()); // Set the user who blocked the chat
        chat = chatRepo.save(chat);
        chatRepositoryMongo.save(chat);
    ...
    public Chat unblockChat(Integer chatId, Integer userId) throws UserException, ChatException {
        ...
        chat.setBlockedBy(null); // Reset the blocked_by field
        chat = chatRepo.save(chat);
        chatRepositoryMongo.save(chat);
