// Purpose: Exception handler for the application. It handles UserException, MethodArgumentNotValidException, NoHandlerFoundException and other exceptions.

package com.axis.team4.codecrafters.chat_history_service.exception;
